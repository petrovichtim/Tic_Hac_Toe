...
public class TwoPlayerActivityBluetooth extends AppCompatActivity implements View.OnClickListener {
  ...
  public void setupBoardView() {
    ...
    if (isTurn) {
      Toast.makeText(TwoPlayerActivityBluetooth.this, "It is your turn!", Toast.LENGTH_SHORT)
          .show();
    }
  }
    ...
    @Override public void handleMessage(Message msg) {
      switch (msg.what) {
          ...
          switch (msg.arg1) {
            ...
            case BluetoothGameService.STATE_DISCONNECTED:
              Intent bluetoothIntent =
                  new Intent(TwoPlayerActivityBluetooth.this, TwoPlayerActivityBluetooth.class);
        ...
        case MESSAGE_DEVICE_NAME:
          ...
          Toast.makeText(TwoPlayerActivityBluetooth.this, "Connected to " + mConnectedDeviceName,
          ...
          break;
        case MESSAGE_TOAST:
          Toast.makeText(TwoPlayerActivityBluetooth.this, msg.getData().getString(TOAST),
              Toast.LENGTH_SHORT).show();
          break;
      }
    }
          ...
          .setNegativeButton("Main Menu", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
              Intent loginActivity =
                  new Intent(TwoPlayerActivityBluetooth.this, LoginActivity.class);
              gameService.stop();
              startActivity(loginActivity);
            }
          });
