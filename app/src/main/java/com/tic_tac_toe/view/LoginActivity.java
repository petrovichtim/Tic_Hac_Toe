...
public class LoginActivity extends AppCompatActivity {
  ...
  public void onePlayer(View v) {
    ...
    /*final RadioButton easy = null;// (RadioButton) layout.findViewById(R.id.easy);
    final RadioButton medium = null; //(RadioButton) layout.findViewById(R.id.medium);
    final RadioButton hard = null;// (RadioButton) layout.findViewById(R.id.hard);
    */
    ...
    builder.setView(layout)
        ...
        .setPositiveButton("Start", new DialogInterface.OnClickListener() {
          @Override public void onClick(DialogInterface dialog, int id) {
            if ((playerName.getText().length() > 0) && (oMarker.isChecked()
                || xMarker.isChecked())) {
              ...
              Toast.makeText(LoginActivity.this, "Please enter a username and select a marker",
        ...
        .setPositiveButton("Start", new DialogInterface.OnClickListener() {
          @Override public void onClick(DialogInterface dialog, int id) {
            if (localGame.isChecked()) {
              ...
              if ((playerOneName.getText().length() > 0) && (playerTwoName.getText().length()
                  > 0)) {
                ...
                if (oMarker.isChecked()) {
                  ...
                  Toast.makeText(LoginActivity.this, "Please select the starting marker",
                      Toast.LENGTH_SHORT).show();
                }
              } else {
                Toast.makeText(LoginActivity.this, "Please enter a name for the players",
                    Toast.LENGTH_SHORT).show();
              }
            } else if (bluetoothGame.isChecked()) {
              Intent bluetoothIntent =
                  new Intent(LoginActivity.this, TwoPlayerActivityBluetooth.class);
              ...
              if (playerOneName.getText().length() > 0) {
                ...
                Toast.makeText(LoginActivity.this, "Please enter a player name", Toast.LENGTH_SHORT)
                    .show();
              }
            } else {

              Toast.makeText(LoginActivity.this, "Please Select a game type", Toast.LENGTH_SHORT)
                  .show();
            }
          }
        })
